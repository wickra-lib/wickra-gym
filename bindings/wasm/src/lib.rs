//! WebAssembly bindings for wickra-gym — a thin wrapper over the `wickra-gym-core`
//! command surface. `Env` forwards command JSONs to
//! [`wickra_gym_core::Env::command_json`] verbatim. The feature-tensor precompute runs
