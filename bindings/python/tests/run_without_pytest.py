...
# should fail loudly here rather than be skipped silently. test_gymnasium is
# not listed: gymnasium requires Python 3.10, so that contract test belongs to
# the pytest rows only.
MODULES = (
    "test_golden",
    "test_streaming",
    "test_completeness",
